...
const highScore: number | boolean = 999;
...
function greet(peopleOrPerson: string | string[]): void {
	if (typeof peopleOrPerson === "string") {
		console.log(`Hello, ${peopleOrPerson}`);
	} else {
		for (let person of peopleOrPerson) {
